...
function _traitIconHelper(is) {
    var retval = "";
    for (var trait in is) {
        if (is[trait] === "stable") {
            retval += ' <span class="glyphicon glyphicon-ok-sign" title="stable"></span>';
        }
        else if (is[trait] === "deprecated") {
            retval += ' <span class="glyphicon glyphicon-remove-sign" title="deprecated"></span>';
        }
        else if (is[trait] === "experimental") {
            retval += ' <span class="glyphicon glyphicon-question-sign" title="experimental"></span>';
        }
    }
    return new handlebars.SafeString(retval);
}

function _alertHelper(is) {
    var retval = "";
    for (var trait in is) {
        if (is[trait] === "stable") {
            retval += ' <span class="glyphicon glyphicon-ok-sign" title="stable"></span> This endpoint is stable.<br/>';
        }
        else if (is[trait] === "deprecated") {
            retval += ' <span class="glyphicon glyphicon-remove-sign" title="deprecated"></span> This endpoint is deprecated.<br/>';
        }
        else if (is[trait] === "experimental") {
            retval += ' <span class="glyphicon glyphicon-question-sign" title="experimental"></span> This endpoint is experimental.</br>';
        }
    }
    return new handlebars.SafeString(retval);
}
